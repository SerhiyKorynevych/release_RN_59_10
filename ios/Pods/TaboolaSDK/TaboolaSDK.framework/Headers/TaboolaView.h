...
- (void)taboolaViewResizeHandler __deprecated_msg("Method is deprecated. Use 'taboolaView: didLoadPlacementNamed: didLoadPlacementNamed: withHeight:' instead");
 ...
 */
-(void)setOptionalPageCommands:(NSDictionary *)pCommands __attribute__((deprecated("Method is deprecated. Use 'setExtraProperties:' instead")));
...
- (void)setOptionalModeCommands:(NSDictionary *)pCommands;__deprecated_msg("Method is deprecated. Use 'setOptionalPageCommands:' instead");

- (void)setUnifiedId:(NSString*)unifiedId; __deprecated_msg("Method is deprecated. Use 'setOptionalPageCommands:' instead");
